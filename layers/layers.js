...
var format_amenity_doctors_healthcare_doctor_6 = new ol.format.GeoJSON();
var features_amenity_doctors_healthcare_doctor_6 = format_amenity_doctors_healthcare_doctor_6.readFeatures(json_amenity_doctors_healthcare_doctor_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_amenity_doctors_healthcare_doctor_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_amenity_doctors_healthcare_doctor_6.addFeatures(features_amenity_doctors_healthcare_doctor_6);
var lyr_amenity_doctors_healthcare_doctor_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_amenity_doctors_healthcare_doctor_6, 
                style: style_amenity_doctors_healthcare_doctor_6,
                popuplayertitle: 'amenity_doctors_healthcare_doctor',
                interactive: false,
                title: '<img src="styles/legend/amenity_doctors_healthcare_doctor_6.png" /> amenity_doctors_healthcare_doctor'
            });
...
var group_POIs = new ol.layer.Group({
                                layers: [lyr_amenity_doctors_healthcare_doctor_6,lyr_schule_7,lyr_kindergaerten_8,lyr_Kultureinrichtungen_u_kirche_9,],
                                fold: 'close',
                                title: 'POIs'});
...
lyr_OpenStreetMap_0.setVisible(false);lyr_DarkGray_1.setVisible(true);lyr_Erreichbarkeit_rzte_2.setVisible(true);lyr_Erreichbarkeit_Kultureinrichtungen_3.setVisible(true);lyr_Erreichbarkeit_Kindergrten_4.setVisible(true);lyr_Erreichbarkeit_Schule_5.setVisible(true);lyr_amenity_doctors_healthcare_doctor_6.setVisible(true);lyr_schule_7.setVisible(true);lyr_kindergaerten_8.setVisible(true);lyr_Kultureinrichtungen_u_kirche_9.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_DarkGray_1,group_Buildings_spatialJoin,group_POIs];
lyr_Erreichbarkeit_rzte_2.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'building': 'building', 'addr:street': 'addr:street', 'addr:postcode': 'addr:postcode', 'addr:housenumber': 'addr:housenumber', 'err_min': 'err_min', 'dr_AA_MODE': 'dr_AA_MODE', 'name_2': 'name_2', });
lyr_Erreichbarkeit_Kultureinrichtungen_3.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'building': 'building', 'addr:street': 'addr:street', 'addr:postcode': 'addr:postcode', 'addr:housenumber': 'addr:housenumber', 'name_2': 'name_2', 'err_min': 'err_min', 'kultur_AA_MODE': 'kultur_AA_MODE', });
lyr_Erreichbarkeit_Kindergrten_4.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'building': 'building', 'addr:street': 'addr:street', 'addr:postcode': 'addr:postcode', 'addr:housenumber': 'addr:housenumber', 'name_2': 'name_2', 'err_min': 'err_min', 'kindergaerten_AA_MODE': 'kindergaerten_AA_MODE', });
lyr_Erreichbarkeit_Schule_5.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'building': 'building', 'addr:street': 'addr:street', 'addr:postcode': 'addr:postcode', 'addr:housenumber': 'addr:housenumber', 'name_2': 'name_2', 'err_min': 'err_min', 'schule_AA_MODE': 'schule_AA_MODE', });
lyr_amenity_doctors_healthcare_doctor_6.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'healthcare': 'healthcare', 'amenity': 'amenity', 'opening_hours:covid19': 'opening_hours:covid19', 'level': 'level', 'contact:phone': 'contact:phone', 'website': 'website', 'wheelchair': 'wheelchair', 'healthcare:speciality': 'healthcare:speciality', 'check_date:opening_hours': 'check_date:opening_hours', 'phone': 'phone', 'operator': 'operator', 'opening_hours': 'opening_hours', 'name': 'name', 'addr:street': 'addr:street', 'addr:postcode': 'addr:postcode', 'addr:housenumber': 'addr:housenumber', 'addr:country': 'addr:country', 'addr:city': 'addr:city', });
...
lyr_Erreichbarkeit_rzte_2.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'building': 'TextEdit', 'addr:street': 'TextEdit', 'addr:postcode': 'TextEdit', 'addr:housenumber': 'TextEdit', 'err_min': 'Range', 'dr_AA_MODE': 'TextEdit', 'name_2': 'TextEdit', });
lyr_Erreichbarkeit_Kultureinrichtungen_3.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'building': 'TextEdit', 'addr:street': 'TextEdit', 'addr:postcode': 'TextEdit', 'addr:housenumber': 'TextEdit', 'name_2': 'TextEdit', 'err_min': 'Range', 'kultur_AA_MODE': 'TextEdit', });
lyr_Erreichbarkeit_Kindergrten_4.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'building': 'TextEdit', 'addr:street': 'TextEdit', 'addr:postcode': 'TextEdit', 'addr:housenumber': 'TextEdit', 'name_2': 'TextEdit', 'err_min': 'Range', 'kindergaerten_AA_MODE': 'TextEdit', });
lyr_Erreichbarkeit_Schule_5.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'building': 'TextEdit', 'addr:street': 'TextEdit', 'addr:postcode': 'TextEdit', 'addr:housenumber': 'TextEdit', 'name_2': 'TextEdit', 'err_min': 'Range', 'schule_AA_MODE': 'TextEdit', });
lyr_amenity_doctors_healthcare_doctor_6.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'healthcare': '', 'amenity': '', 'opening_hours:covid19': '', 'level': '', 'contact:phone': '', 'website': '', 'wheelchair': '', 'healthcare:speciality': '', 'check_date:opening_hours': '', 'phone': '', 'operator': '', 'opening_hours': '', 'name': '', 'addr:street': '', 'addr:postcode': '', 'addr:housenumber': '', 'addr:country': '', 'addr:city': '', });
...
lyr_Erreichbarkeit_rzte_2.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'Erreichbarkeit (Min)': 'header label - always visible', 'dr_AA_MODE': 'header label - visible with data', 'name_2': 'header label - visible with data', });
lyr_Erreichbarkeit_Kultureinrichtungen_3.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'name_2': 'inline label - visible with data', 'Erreichbarkeit (Min)': 'header label - always visible', 'kultur_AA_MODE': 'header label - visible with data', });
lyr_Erreichbarkeit_Kindergrten_4.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'name_2': 'inline label - visible with data', 'Erreichbarkeit (Min)': 'header label - always visible', 'kindergaerten_AA_MODE': 'header label - visible with data', });
lyr_Erreichbarkeit_Schule_5.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'name_2': 'inline label - visible with data', 'Erreichbarkeit (Min)': 'header label - always visible', 'schule_AA_MODE': 'header label - visible with data', });
lyr_amenity_doctors_healthcare_doctor_6.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'healthcare': 'no label', 'amenity': 'no label', 'opening_hours:covid19': 'no label', 'level': 'no label', 'contact:phone': 'no label', 'website': 'no label', 'wheelchair': 'no label', 'healthcare:speciality': 'no label', 'check_date:opening_hours': 'no label', 'phone': 'no label', 'operator': 'no label', 'opening_hours': 'no label', 'name': 'no label', 'addr:street': 'no label', 'addr:postcode': 'no label', 'addr:housenumber': 'no label', 'addr:country': 'no label', 'addr:city': 'no label', });
