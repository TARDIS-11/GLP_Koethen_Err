...
var format_Erreichbarkeit_rzte_1 = new ol.format.GeoJSON();
var features_Erreichbarkeit_rzte_1 = format_Erreichbarkeit_rzte_1.readFeatures(json_Erreichbarkeit_rzte_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Erreichbarkeit_rzte_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Erreichbarkeit_rzte_1.addFeatures(features_Erreichbarkeit_rzte_1);
var lyr_Erreichbarkeit_rzte_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Erreichbarkeit_rzte_1, 
                style: style_Erreichbarkeit_rzte_1,
                popuplayertitle: 'Erreichbarkeit_Ärzte',
                interactive: true,
    title: 'Erreichbarkeit_Ärzte<br />\
    <img src="styles/legend/Erreichbarkeit_rzte_1_0.png" /> 5<br />\
    <img src="styles/legend/Erreichbarkeit_rzte_1_1.png" /> 10<br />\
    <img src="styles/legend/Erreichbarkeit_rzte_1_2.png" /> 15<br />\
    <img src="styles/legend/Erreichbarkeit_rzte_1_3.png" /> <br />' });
...
var format_Erreichbarkeit_Kindergrten_3 = new ol.format.GeoJSON();
var features_Erreichbarkeit_Kindergrten_3 = format_Erreichbarkeit_Kindergrten_3.readFeatures(json_Erreichbarkeit_Kindergrten_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Erreichbarkeit_Kindergrten_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Erreichbarkeit_Kindergrten_3.addFeatures(features_Erreichbarkeit_Kindergrten_3);
var lyr_Erreichbarkeit_Kindergrten_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Erreichbarkeit_Kindergrten_3, 
                style: style_Erreichbarkeit_Kindergrten_3,
                popuplayertitle: 'Erreichbarkeit_Kindergärten',
                interactive: true,
    title: 'Erreichbarkeit_Kindergärten<br />\
    <img src="styles/legend/Erreichbarkeit_Kindergrten_3_0.png" /> 5<br />\
    <img src="styles/legend/Erreichbarkeit_Kindergrten_3_1.png" /> 10<br />\
    <img src="styles/legend/Erreichbarkeit_Kindergrten_3_2.png" /> 15<br />\
    <img src="styles/legend/Erreichbarkeit_Kindergrten_3_3.png" /> <br />' });
var format_Erreichbarkeit_Schule_4 = new ol.format.GeoJSON();
var features_Erreichbarkeit_Schule_4 = format_Erreichbarkeit_Schule_4.readFeatures(json_Erreichbarkeit_Schule_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Erreichbarkeit_Schule_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Erreichbarkeit_Schule_4.addFeatures(features_Erreichbarkeit_Schule_4);
var lyr_Erreichbarkeit_Schule_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Erreichbarkeit_Schule_4, 
                style: style_Erreichbarkeit_Schule_4,
                popuplayertitle: 'Erreichbarkeit_Schule',
                interactive: true,
    title: 'Erreichbarkeit_Schule<br />\
    <img src="styles/legend/Erreichbarkeit_Schule_4_0.png" /> 5<br />\
    <img src="styles/legend/Erreichbarkeit_Schule_4_1.png" /> 10<br />\
    <img src="styles/legend/Erreichbarkeit_Schule_4_2.png" /> 15<br />\
    <img src="styles/legend/Erreichbarkeit_Schule_4_3.png" /> <br />' });
var format_amenity_doctors_healthcare_doctor_5 = new ol.format.GeoJSON();
var features_amenity_doctors_healthcare_doctor_5 = format_amenity_doctors_healthcare_doctor_5.readFeatures(json_amenity_doctors_healthcare_doctor_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_amenity_doctors_healthcare_doctor_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_amenity_doctors_healthcare_doctor_5.addFeatures(features_amenity_doctors_healthcare_doctor_5);
var lyr_amenity_doctors_healthcare_doctor_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_amenity_doctors_healthcare_doctor_5, 
                style: style_amenity_doctors_healthcare_doctor_5,
                popuplayertitle: 'amenity_doctors_healthcare_doctor',
                interactive: false,
                title: '<img src="styles/legend/amenity_doctors_healthcare_doctor_5.png" /> amenity_doctors_healthcare_doctor'
            });
var format_schule_6 = new ol.format.GeoJSON();
var features_schule_6 = format_schule_6.readFeatures(json_schule_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_schule_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_schule_6.addFeatures(features_schule_6);
var lyr_schule_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_schule_6, 
                style: style_schule_6,
                popuplayertitle: 'schule',
                interactive: false,
                title: '<img src="styles/legend/schule_6.png" /> schule'
            });
var format_kindergaerten_7 = new ol.format.GeoJSON();
var features_kindergaerten_7 = format_kindergaerten_7.readFeatures(json_kindergaerten_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_kindergaerten_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_kindergaerten_7.addFeatures(features_kindergaerten_7);
var lyr_kindergaerten_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_kindergaerten_7, 
                style: style_kindergaerten_7,
                popuplayertitle: 'kindergaerten',
                interactive: false,
                title: '<img src="styles/legend/kindergaerten_7.png" /> kindergaerten'
            });
var format_Kultureinrichtungen_u_kirche_8 = new ol.format.GeoJSON();
var features_Kultureinrichtungen_u_kirche_8 = format_Kultureinrichtungen_u_kirche_8.readFeatures(json_Kultureinrichtungen_u_kirche_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Kultureinrichtungen_u_kirche_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Kultureinrichtungen_u_kirche_8.addFeatures(features_Kultureinrichtungen_u_kirche_8);
var lyr_Kultureinrichtungen_u_kirche_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Kultureinrichtungen_u_kirche_8, 
                style: style_Kultureinrichtungen_u_kirche_8,
                popuplayertitle: 'Kultureinrichtungen_u_kirche',
                interactive: false,
    title: 'Kultureinrichtungen_u_kirche<br />\
    <img src="styles/legend/Kultureinrichtungen_u_kirche_8_0.png" /> Kino<br />\
    <img src="styles/legend/Kultureinrichtungen_u_kirche_8_1.png" /> Bibliothek<br />\
    <img src="styles/legend/Kultureinrichtungen_u_kirche_8_2.png" /> Religiöse Einrichtung<br />\
    <img src="styles/legend/Kultureinrichtungen_u_kirche_8_3.png" /> Rathaus<br />\
    <img src="styles/legend/Kultureinrichtungen_u_kirche_8_4.png" /> Sehenswürdigkeit<br />' });
var group_POIs = new ol.layer.Group({
                                layers: [lyr_amenity_doctors_healthcare_doctor_5,lyr_schule_6,lyr_kindergaerten_7,lyr_Kultureinrichtungen_u_kirche_8,],
                                fold: 'close',
                                title: 'POIs'});
var group_Buildings_spatialJoin = new ol.layer.Group({
                                layers: [lyr_Erreichbarkeit_rzte_1,lyr_Erreichbarkeit_Kultureinrichtungen_2,lyr_Erreichbarkeit_Kindergrten_3,lyr_Erreichbarkeit_Schule_4,],
                                fold: 'close',
                                title: 'Buildings_spatial Join'});

lyr_DarkGray_0.setVisible(true);lyr_Erreichbarkeit_rzte_1.setVisible(true);lyr_Erreichbarkeit_Kultureinrichtungen_2.setVisible(true);lyr_Erreichbarkeit_Kindergrten_3.setVisible(true);lyr_Erreichbarkeit_Schule_4.setVisible(true);lyr_amenity_doctors_healthcare_doctor_5.setVisible(true);lyr_schule_6.setVisible(true);lyr_kindergaerten_7.setVisible(true);lyr_Kultureinrichtungen_u_kirche_8.setVisible(true);
var layersList = [lyr_DarkGray_0,group_Buildings_spatialJoin,group_POIs];
lyr_Erreichbarkeit_rzte_1.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'building': 'building', 'addr:street': 'addr:street', 'addr:postcode': 'addr:postcode', 'addr:housenumber': 'addr:housenumber', 'Erreichbarkeit (Min)': 'Erreichbarkeit (Min)', 'dr_AA_MODE': 'dr_AA_MODE', 'name_2': 'name_2', });
...
lyr_Erreichbarkeit_Kindergrten_3.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'building': 'TextEdit', 'addr:street': 'TextEdit', 'addr:postcode': 'TextEdit', 'addr:housenumber': 'TextEdit', 'name_2': 'TextEdit', 'Erreichbarkeit (Min)': 'Range', 'kindergaerten_AA_MODE': 'TextEdit', });
lyr_Erreichbarkeit_Schule_4.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'building': 'TextEdit', 'addr:street': 'TextEdit', 'addr:postcode': 'TextEdit', 'addr:housenumber': 'TextEdit', 'name_2': 'TextEdit', 'Erreichbarkeit (Min)': 'Range', 'schule_AA_MODE': 'TextEdit', });
lyr_amenity_doctors_healthcare_doctor_5.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'healthcare': '', 'amenity': '', 'opening_hours:covid19': '', 'level': '', 'contact:phone': '', 'website': '', 'wheelchair': '', 'healthcare:speciality': '', 'check_date:opening_hours': '', 'phone': '', 'operator': '', 'opening_hours': '', 'name': '', 'addr:street': '', 'addr:postcode': '', 'addr:housenumber': '', 'addr:country': '', 'addr:city': '', });
lyr_schule_6.set('fieldImages', {'fid': '', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'amenity': 'TextEdit', 'operator:type': 'TextEdit', 'isced:level': 'TextEdit', 'contact:website': 'TextEdit', 'education': 'TextEdit', 'check_date': 'TextEdit', 'material': 'TextEdit', 'height': 'TextEdit', 'barrier': 'TextEdit', 'building:levels': 'TextEdit', 'website': 'TextEdit', 'religion': 'TextEdit', 'building': 'TextEdit', 'addr:country': 'TextEdit', 'phone': 'TextEdit', 'name': 'TextEdit', 'addr:street': 'TextEdit', 'addr:postcode': 'TextEdit', 'addr:housenumber': 'TextEdit', 'addr:city': 'TextEdit', 'ignore_amenity_school_full_id': '', 'ignore_amenity_school_osm_type': '', 'ignore_amenity_school_amenity': '', 'ignore_amenity_school_public_transport': '', 'ignore_amenity_school_operator': '', 'ignore_amenity_school_bus': '', 'ignore_amenity_school_entrance': '', 'ignore_amenity_school_maxwidth': '', 'ignore_amenity_school_maxheight': '', 'ignore_amenity_school_barrier': '', 'ignore_amenity_school_wheelchair': '', 'ignore_amenity_school_website': '', 'ignore_amenity_school_phone': '', 'ignore_amenity_school_addr:street': '', 'ignore_amenity_school_addr:postcode': '', 'ignore_amenity_school_addr:housenumber': '', 'ignore_amenity_school_addr:country': '', 'ignore_amenity_school_addr:city': '', 'ignore_amenity_school_name': '', });
lyr_kindergaerten_7.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'amenity': '', 'website': '', 'operator': '', 'contact:website': '', 'capacity': '', 'building': '', 'phone': '', 'addr:street': '', 'addr:postcode': '', 'addr:housenumber': '', 'addr:city': '', 'name': '', });
lyr_Kultureinrichtungen_u_kirche_8.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'amenity': '', 'tourism': '', 'ref': '', 'operator': '', 'description': '', 'contact:facebook': '', 'checkpoint:type': '', 'checkpoint': '', 'toilets:wheelchair': '', 'museum': '', 'contact:website': '', 'contact:phone': '', 'contact:email': '', 'width': '', 'entrance': '', 'comment': '', 'service_times': '', 'check_date': '', 'ref:isil': '', 'opening_hours': '', 'email': '', 'building': '', 'designation': '', 'natural': '', 'height': '', 'wikidata': '', 'website': '', 'religion': '', 'phone': '', 'denomination': '', 'addr:street': '', 'addr:postcode': '', 'addr:housenumber': '', 'addr:country': '', 'addr:city': '', 'wikimedia_commons': '', 'ref:lda': '', 'man_made': '', 'lda:criteria': '', 'image': '', 'heritage:operator': '', 'heritage': '', 'wheelchair': '', 'name': '', });
lyr_Erreichbarkeit_rzte_1.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'Erreichbarkeit (Min)': 'header label - always visible', 'dr_AA_MODE': 'header label - visible with data', 'name_2': 'header label - visible with data', });
