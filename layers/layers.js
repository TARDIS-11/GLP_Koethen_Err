...
lyr_OpenStreetMap_0.setVisible(true);lyr_DarkGray_1.setVisible(true);lyr_Erreichbarkeit_rzte_2.setVisible(true);lyr_Erreichbarkeit_Kultureinrichtungen_3.setVisible(true);lyr_Erreichbarkeit_Kindergrten_4.setVisible(true);lyr_Erreichbarkeit_Schule_5.setVisible(true);lyr_amenity_doctors_healthcare_doctor_6.setVisible(true);lyr_schule_7.setVisible(true);lyr_kindergaerten_8.setVisible(true);lyr_Kultureinrichtungen_u_kirche_9.setVisible(true);
...
lyr_Erreichbarkeit_rzte_2.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'err_min': 'header label - always visible', 'dr_AA_MODE': 'header label - visible with data', 'name_2': 'inline label - visible with data', });
lyr_Erreichbarkeit_Kultureinrichtungen_3.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'name_2': 'inline label - visible with data', 'err_min': 'header label - always visible', 'kultur_AA_MODE': 'header label - visible with data', });
lyr_Erreichbarkeit_Kindergrten_4.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'name_2': 'inline label - visible with data', 'err_min': 'header label - always visible', 'kindergaerten_AA_MODE': 'header label - visible with data', });
lyr_Erreichbarkeit_Schule_5.set('fieldLabels', {'fid': 'hidden field', 'full_id': 'hidden field', 'osm_id': 'hidden field', 'building': 'hidden field', 'addr:street': 'inline label - visible with data', 'addr:postcode': 'inline label - visible with data', 'addr:housenumber': 'inline label - visible with data', 'name_2': 'inline label - visible with data', 'err_min': 'header label - always visible', 'schule_AA_MODE': 'header label - visible with data', });
